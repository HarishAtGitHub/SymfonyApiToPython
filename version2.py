                    ...
                    if (method_name.lower() == "put" or method_name.lower() == "post" or method_name.lower() == "delete"):
                        for param in param_list:
                            ...
                            if keys:
                                ...
                                print('    ' + '    ' + param + ' = document' + '[\'' + array_name + '\']' + keys.group(1).replace("description", "descriptionText") , file=template_file)
                            else :
                                #check if descriptionText replacement is unncessecary
                                print('    ' + '    ' + param + ' = document' + '[\'' + array_name + '\']' + '[\'' + param.replace("description", "descriptionText") + '\']' , file=template_file)
                    if (method_name.lower() == "put" or method_name.lower() == "post"):
